...
if __name__ == '__main__':
    sql="select pdate,lg,hname,aname,deal_bf_price_3,deal_bf_volume_3,deal_bf_price_1,deal_bf_volume_1,deal_bf_price_0,deal_bf_volume_0,sl_odds_3,sl_percent_3,sl_odds_1,sl_percent_1,sl_odds_0,sl_percent_0,gameresult,score,score_dif from td_ptl_okooo_data  order by id asc;"
