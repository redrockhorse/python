...
if __name__ == '__main__':
    ...
    #plt.hist(lbpMatrix.reshape(lbpMatrix.shape[0]*lbpMatrix.shape[1],))
    top10 = Counter(lbpMatrix.reshape(lbpMatrix.shape[0]*lbpMatrix.shape[1],)).most_common(10)
    # print(Counter(lbpMatrix.reshape(lbpMatrix.shape[0]*lbpMatrix.shape[1],)).most_common(10))
    # for i in top10:
    #     print(i[0])
    #     print(bin(int(i[0])).replace('0b',''))
    #     binstr = bin(int(i[0])).replace('0b','')
    #     for l in range(8-len(binstr)):
    #         binstr = '0' + binstr
    #     print(binstr)
    #
    # print(lbpMatrix.shape[1])
    preResult = []
