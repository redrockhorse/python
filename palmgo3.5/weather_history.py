...
'''
#print(arealist)
#arealist={'盘龙区':'72053','吴江区':'60036','大厂回族自治县':'70178','会泽县':'70866','和平区':'71453','崇礼县':'70176','广阳区':'71628','太仓市':'60041','吴中区':'71366','湾里区':'71936','灵武市':'70509','福田区':'72036','安次区':'71627','锡山区':'71364','苍溪县':'70702','武清区':'60138','水磨沟区':'71703','渝水区':'71948','浦东新区': '71146', '萧山区': '60175', '平谷区': '60204', '丰城市': '60502', '昆山市': '60037', '朝阳区': '71141', '越城区': '3580', '密云县': '60247', '大兴区': '60205', '宝山区': '71072', '长宁区': '71448', '海淀区': '71144', '崇明县': '60005', '云岩区': '71412', '普陀区': '71450', '海盐县': '60121', '乐清市': '60180', '丰台区': '71142', '安岳县': '61088', '昌平区': '60198', '延庆县': '60199', '东城区': '71445', '兴隆县': '60275', '涿州市': '60523', '西城区': '71446', '闸北区': '79346', '怀柔区': '60207', '闵行区': '60008', '金山区': '60006', '嘉善县': '60194', '青浦区': '60007', '中山市市辖区': '59485', '固安县': '70189', '黄浦区': '71447', '香河县': '60111', '嘉定区': '60010', '鼓楼区': '71799', '奉贤区': '60298', '通州区': '71071', '门头沟区': '60246', '西乡塘区': '72066', '岳麓区': '71952', '长乐市': '60396', '秀洲区': '71859', '石景山区': '71143', '房山区': '60206', '徐汇区': '71147', '怀来县': '70197', '顺义区': '60202', '彭水苗族土家族自治县': '60978', '武侯区': '71988', '三河市': '60522', '静安区': '71449', '松江区': '60009', '虹口区': '71451', '杨浦区': '71452'}
#tmplist ={"安次区":"","安岳县":"","宝山区":"","苍溪县":"","昌平区":"","朝阳区":"","崇礼县":"","崇明县":"","大厂回族自治县":"","大兴区":"","东城区":"","房山区":"","丰城市":"","丰台区":"","奉贤区":"","福田区":"","鼓楼区":"","固安县":"","广阳区":"","海淀区":"","海盐县":"","和平区":"","虹口区":"","怀来县":"","怀柔区":"","黄浦区":"","会泽县":"","嘉定区":"","嘉善县":"","金山区":"","静安区":"","昆山市":"","乐清市":"","灵武市":"","门头沟区":"","密云县":"","闵行区":"","盘龙区":"","彭水苗族土家族自治县":"","平谷区":"","浦东新区":"","普陀区":"","青浦区":"","三河市":"","石景山区":"","水磨沟区":"","顺义区":"","松江区":"","太仓市":"","通州区":"","湾里区":"","吴江区":"","吴中区":"","武侯区":"","武清区":"","西城区":"","西乡塘区":"","锡山区":"","香河县":"","萧山区":"","兴隆县":"","秀洲区":"","徐汇区":"","延庆县":"","杨浦区":"","渝水区":"","岳麓区":"","越城区":"","云岩区":"","闸北区":"","长乐市":"","长宁区":"","中山市市辖区":"","涿州市":""}
arealist={'北京市':'54511','上海市':'58362'}
'''
for key in tmplist:
    if key not in arealist:
        print(key)
...
outputfile =open('E:\\desktop\\weatherhis_bj_sh.txt','w')
for m in monthlist:
    #print(m)
    for a in arealist:
        ...
        if r.status_code !=200:
            print(m,a,'http://tianqi.2345.com/t/wea_history/js/'+m+'/'+arealist[a]+'_'+m+'.js')
        if r.status_code ==200:
            result = r.text
            jsonstr=result.split('=')[1].replace(';','').replace(',{}','').replace('\'','"').replace('{','{"').replace(':','":').replace(',',',"').replace('"{','{')
            '''
          ...
          '''
            ...
            for tq in weatherlist:
                ...
                outputfile.write(a+','+tq['ymd']+' 00:00:00'+','+tq['bWendu']+','+tq['yWendu']+','+tq['tianqi']+','+tq['fengxiang']+','+tq['fengli']+','+aqi+','+aqiInfo+','+aqiLevel+'\n')
                insert_sql ="INSERT INTO td_weather_his_data VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)"
                cursor.execute(insert_sql,(a,tq['ymd']+' 00:00:00',tq['bWendu'],tq['yWendu'],tq['tianqi'],tq['fengxiang'],tq['fengli'],aqi,aqiInfo,aqiLevel))
