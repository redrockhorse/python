...
camera = cv2.VideoCapture('/Users/hongyanma/gitspace/python/python/data/1.avi') # 从文件读取视频,Todo:只需要修改成自己的视频路径即可进行测试
...
while True:
    ...
    for i in x:
        ...
        cv2.rectangle(emptyImage, (i * 2, (Width_choose - pixel_sum[i] // 255) * 10), ((i + 1) * 2, Width_choose * 10),255, 1)
