...
province_city = {
    ...
    '贵州省': ['黔东南州','贵阳市', '安顺市', '遵义市', '六盘水市', '兴义市', '都匀市', '凯里市', '毕节市', '清镇市', '铜仁市', '赤水市', '仁怀市', '福泉市'],
    ...
    '湖北省': ['襄樊市','武汉市', '荆门市', '咸宁市', '襄阳市', '荆州市', '黄石市', '宜昌市', '随州市', '鄂州市', '孝感市', '黄冈市', '十堰市', '枣阳市', '老河口市', '恩施市', '仙桃市', '天门市', '钟祥市', '潜江市', '麻城市', '洪湖市', '汉川市', '赤壁市', '松滋市', '丹江口市', '武穴市', '广水市', '石首市', '大冶市', '枝江市', '应城市', '宜城市', '当阳市', '安陆市', '宜都市', '利川市'],
    ...
    '山西省': ['晋城市','太原市', '大同市', '阳泉市', '长治市', '临汾市', '晋中市', '运城市', '忻州市', '朔州市', '吕梁市', '古交市', '高平市', '永济市', '孝义市', '侯马市', '霍州市', '介休市', '河津市', '汾阳市', '原平市', '潞城市'],
    '陕西省': ['西安市', '咸阳市', '榆林市', '宝鸡市', '铜川市', '渭南市', '汉中市', '安康市', '商洛市', '延安市', '韩城市', '兴平市', '华阴市'],
    '四川省': ['凉山州','成都市', '广安市', '德阳市', '乐山市', '巴中市', '内江市', '宜宾市', '南充市', '都江堰市', '自贡市', '泸州市', '广元市', '达州市', '资阳市', '绵阳市', '眉山市', '遂宁市', '雅安市', '阆中市', '攀枝花市', '广汉市', '绵竹市', '万源市', '华蓥市', '江油市', '西昌市', '彭州市', '简阳市', '崇州市', '什邡市', '峨眉山市', '邛崃市', '双流县'],
    '云南省': ['文山州','普洱市','大理州','昆明市', '玉溪市', '大理市', '曲靖市', '昭通市', '保山市', '丽江市', '临沧市', '楚雄市', '开远市', '个旧市', '景洪市', '安宁市', '宣威市'],
    ...
    '西藏藏族自治区': ['拉萨市', '日喀则市'],
    '新疆维吾尔自治区': ['巴音郭楞州','昌吉州','吐鲁番地区','哈密地区','乌鲁木齐市', '石河子市', '喀什市', '阿勒泰市', '阜康市', '库尔勒市', '阿克苏市', '阿拉尔市', '哈密市', '克拉玛依市', '昌吉市', '奎屯市', '米泉市', '和田市'],
    '香港': ['香港'],
    '澳门': ['澳门']}
city_province ={}
...
with open('/Users/hongyanma/Desktop/收费站.json','r',encoding='utf-8') as file:
    info = json.load(file)
    #print(info)
    for item in info['data']:
        xname=item['xname'].split('|')
        xy = item['pline'][0]+','+item['pline'][1]
        x = item['pline'][0]
        y = item['pline'][1]
        #print(xname)
        tname = xname[0]
        rname = xname[1]
        cname = xname[2]
        # if cname not in city_province:
        #     pname = ''
        #     print(cname)
        # else:
        pname = city_province[cname]
        print(tname,rname,cname,pname)
        id = str(uuid.uuid4())
        sqlstr = "INSERT INTO `datacapture`.`layer_tollstation`(`id`,`x`,`y`,`province`,`cityname`,`08095941aa6c4e5a85f4cb628c1ebfbd`,`d6d1be12cbdf4222aab047f0a314fd46`) VALUES (%s,%s,%s,%s,%s,%s,%s)"
        cur.execute(sqlstr,(id,x,y,pname,cname,tname,rname))
        conn.commit()